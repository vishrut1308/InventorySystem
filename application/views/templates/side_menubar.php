...
Security
Insights
InventorySystem/application/views/templates/side_menubar.php /
@ronknight
ronknight Revert "Migrate to CodeIgniter4"
Latest commit 6b4db45 on Mar 11, 2021
 History
 2 contributors
@ronknight@peppers96
161 lines (139 sloc)  8.05 KB
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($user_permission): ?>
            ...
            <li class="treeview" id="mainGroupNav">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createGroup', $user_permission)): ?>
                  <li id="addGroupNav"><a href="<?php echo base_url('groups/create') ?>"><i class="fa fa-circle-o"></i> Add Club</a></li>
                <?php endif; ?>
                <?php if(in_array('updateGroup', $user_permission) || in_array('viewGroup', $user_permission) || in_array('deleteGroup', $user_permission)): ?>
                <li id="manageGroupNav"><a href="<?php echo base_url('groups') ?>"><i class="fa fa-circle-o"></i> Manage Clubs</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
          ...
          <?php if(in_array('createStore', $user_permission) || in_array('updateStore', $user_permission) || in_array('viewStore', $user_permission) || in_array('deleteStore', $user_permission)): ?>
            <li id="storeNav">
              <a href="<?php echo base_url('stores/') ?>">
                <i class="fa fa-files-o"></i> <span>Discarded Products</span>
              </a>
            </li>
          <?php endif; ?>
          ...
          <?php if(in_array('createStore', $user_permission) || in_array('updateStore', $user_permission) || in_array('viewStore', $user_permission) || in_array('deleteStore', $user_permission)): ?>
            <li id="storeNav">
              <a href="<?php echo base_url('stores/') ?>">
                <i class="fa fa-files-o"></i> <span>Purchase History</span>
              </a>
            </li>
          <?php endif; ?>
...
Blog
About
InventorySystem/side_menubar.php at master · ronknight/InventorySystem